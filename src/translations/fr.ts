export const fr = {
  ...
  settings: {
    ...
    deleteModalText: "Cette action est irréversible. Votre compte et toutes vos données seront définitivement supprimés. Cette action ne peut pas être annulée.",
